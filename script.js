...
//function renderizarAlbumes(listado) {
    ...
    function renderizarAlbumes(albumesFamosos){
...
function mostrarDatosEnPerfil(albumesFamosos) {
    ...
    const pluralAlbumes = contadorAlbumes === 1 ? "album" : "albumes";
    ...
    <p>
      <span id="cant-albums">${contadorAlbumes} ${pluralAlbumes}</span> en tu listado - En total <span id="cant-favoritos">${contadorFavoritos} ${pluralFavoritos}</span>
    </p>
    `
